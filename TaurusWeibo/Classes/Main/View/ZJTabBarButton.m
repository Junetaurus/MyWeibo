...
#define ZJImageRidio 0.7

@interface ZJTabBarButton ()

@property (nonatomic ,weak) ZJBadgeView *badgeView;
...
{
    if (_badgeView == nil) {
        ZJBadgeView *btn = [ZJBadgeView buttonWithType:UIButtonTypeCustom];
...
- (void)layoutSubviews
{
    ...
    CGFloat imageH = self.bounds.size.height * ZJImageRidio;
